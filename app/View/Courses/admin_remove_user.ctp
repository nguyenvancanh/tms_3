...
<section class="lead">
	...
	echo $this->Form->select('course_id', $courses, ['empty' => false,
		...
		'label' => 'View', 'multiple title' => __('Choose one of the following...')
	]);
	$submitOptions = array(
		'label' => __('Select'),
	...
	<table class="table table-hover">
		...
		<?php foreach ($users as $user): ?>
			<tr>
				...
				<td><?php
					echo $this->Html->link(__('Remove'), ['controller' => 'courses', 'action' => 'delete', 'user', $user['User']['id'], 'admin' => true], ['escape' => false, 'class' => 'btn btn-success btn-sm']);
					?>
				</td>
			</tr>
		<?php endforeach; ?>
